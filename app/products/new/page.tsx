...
export default function NewProductPage() {
  ...
  const checkSkuUniqueness = async (sku: string) => {
    ...
    try {
      const response = await productsService.checkSkuUniqueness(sku);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Create a new product record with details and inventory information
              </p>
            </div>
          </div>
        </div>
          ...
          {!isOnline && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                You are currently offline. The product will be created when you reconnect to the internet.
              </p>
            </div>
          )}
